//Crea la una clase llamada Instituto que permita crear objetos de este tipo. Un instituto necesita obligatoriamente el codigoInstituto y su nombre. Además, almacenará grupos
export default class Instituto {
    ...
    totalAlumnosInstituto() {
        ...
        if (this.GruposInstituto.length != 0) {
            this._gruposInstituto.forEach(grupo => totalAlumnos += grupo.NumeroAlumnos);
        }
        return totalAlumnos;
    }
}